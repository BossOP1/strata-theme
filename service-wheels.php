<?php
$page_title       = 'Wheels & Tires | Stradaworks Automotive';
$page_description = 'Wheel and tire fitting, balancing and precision alignment for street and track vehicles.';
...
?>
    ...
    <header class="relative w-full h-[70vh] min-h-[500px] overflow-hidden">
        <div class="absolute inset-0">
            <img src="<?= asset('images/wheels_tires.png') ?>" class="w-full h-full object-cover" alt="Wheels and Tires">
        ...
        <div class="max-w-[1400px] mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/gallery_wheel_closeup.png') ?>"
                ...
                <!-- Project 2 -->
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-wheel-alignment.jpg') ?>"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                ...
                <!-- Project 3 -->
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-green-calipers.jpg') ?>"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
