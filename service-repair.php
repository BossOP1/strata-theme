<?php
$page_title       = 'Automotive Repair | Stradaworks Automotive';
$page_description = 'Full-service automotive repair for domestic and foreign vehicles, from routine maintenance to major engine work.';
...
?>
    ...
    <header class="relative w-full h-[70vh] min-h-[500px] overflow-hidden">
        <div class="absolute inset-0">
            <img src="<?= asset('images/automotive_repair.png') ?>" class="w-full h-full object-cover" alt="Engine Repair">
    ...
    <section class="py-20 bg-zinc-950 border-b border-zinc-900">
        <div class="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                ...
                <img src="<?= asset('images/automotive_repair.png') ?>"
        ...
        <div class="max-w-[1400px] mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-engine-wrench.jpg') ?>"
                ...
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-brake-rotor.jpg') ?>"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                ...
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/shop-clutch.jpg') ?>"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
