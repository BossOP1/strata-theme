<?php
$page_title       = 'A/C Service | Stradaworks Automotive';
$page_description = 'Automotive air conditioning diagnosis, recharge and compressor replacement for domestic and foreign vehicles.';
...
?>
    ...
    <header class="relative w-full h-[70vh] min-h-[500px] overflow-hidden">
        <div class="absolute inset-0">
            <img src="<?= asset('images/air_conditioning.png') ?>" class="w-full h-full object-cover" alt="AC Repair">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-12">
             ...
             <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-ac-compressor.jpg') ?>"
                 ...
                 <!-- Project 2 -->
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-heater-core.jpg') ?>"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                 ...
                 <!-- Project 3 -->
                <div class="group relative overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[4/3]">
                    <img src="<?= asset('images/service-ac-gauges.jpg') ?>"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
